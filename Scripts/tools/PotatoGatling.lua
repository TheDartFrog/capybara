...
--dofile( "$CONTENT_DATA/Scripts/WoM_projectiles.lua" )
...
local renderables = {
	...
	"$CONTENT_DATA/Tools/Renderables/PAINTGUN/Renderables/barrel_spinner.rend"
	--"$CONTENT_DATA/Tools/Renderables/PAINTGUN/Renderables/sight_spinner.rend",
...
local renderablesTp = {}
local renderablesFp = {"$SURVIVAL_DATA/Character/Char_Male/char_male_empty.rend"}
...
function PotatoGatling.loadAnimations( self )
	...
	self.tpAnimations = createTpAnimations(
		self.tool,
		{
			shoot = { "spudgun_spinner_shoot_tp", { crouch = "spudgun_spinner_shoot_tp" } },
			aim = { "spudgun_spinner_shoot_tp", { crouch = "spudgun_spinner_shoot_tp" } },
			aimShoot = { "spudgun_spinner_shoot_tp", { crouch = "spudgun_spinner_shoot_tp" } },
			idle = { "spudgun_spinner_shoot_tp" },
			pickup = { "spudgun_spinner_shoot_tp", { nextAnimation = "spudgun_spinner_shoot_tp" } },
			putdown = { "spudgun_spinner_shoot_tp" }
		}
	)
	local movementAnimations = {
		idle = "spudgun_spinner_shoot_tp",
		idleRelaxed = "spudgun_spinner_shoot_tp",

		sprint = "spudgun_spinner_shoot_tp",
		runFwd = "spudgun_spinner_shoot_tp",
		runBwd = "spudgun_spinner_shoot_tp",

		jump = "spudgun_spinner_shoot_tp",
		jumpUp = "spudgun_spinner_shoot_tp",
		jumpDown = "spudgun_spinner_shoot_tp",

		land = "spudgun_spinner_shoot_tp",
		landFwd = "spudgun_spinner_shoot_tp",
		landBwd = "spudgun_spinner_shoot_tp",

		crouchIdle = "spudgun_spinner_shoot_tp",
		crouchFwd = "spudgun_spinner_shoot_tp",
		crouchBwd = "spudgun_spinner_shoot_tp"
	}
	...
	setTpAnimation( self.tpAnimations, "spudgun_spinner_shoot_tp", 5.0 )

	if self.tool:isLocal() then
		self.fpAnimations = createFpAnimations(
			self.tool,
			{
				equip = { "spudgun_spinner_shoot_tp", { nextAnimation = "spudgun_spinner_shoot_tp" } },
				unequip = { "spudgun_spinner_shoot_tp" },

				idle = { "spudgun_spinner_shoot_tp", { looping = true } },
				shoot = { "spudgun_spinner_shoot_tp", { nextAnimation = "spudgun_spinner_shoot_tp" } },
				
				aimInto = { "spudgun_spinner_shoot_tp", { nextAnimation = "spudgun_spinner_shoot_tp" } },
				aimExit = { "spudgun_spinner_shoot_tp", { nextAnimation = "spudgun_spinner_shoot_tp", blendNext = 0 } },
				aimIdle = { "spudgun_spinner_shoot_tp", { looping = true} },
				aimShoot = { "spudgun_spinner_shoot_tp", { nextAnimation = "spudgun_spinner_shoot_tp"} },

				sprintInto = { "spudgun_spinner_shoot_tp", { nextAnimation = "spudgun_spinner_shoot_tp",  blendNext = 0.2 } },
				sprintExit = { "spudgun_spinner_shoot_tp", { nextAnimation = "spudgun_spinner_shoot_tp",  blendNext = 0 } },
				sprintIdle = { "spudgun_spinner_shoot_tp", { looping = true } },
			}
		)
	end
...
function PotatoGatling.client_onUpdate( self, dt )
	...
	local crouchWeight = false and 1.0 or 0.0
	...
	for name, animation in pairs( self.tpAnimations.animations ) do
		...
		if name == self.tpAnimations.currentAnimation then
			...
			if animation.time >= animation.info.duration - self.blendTime then
				if ( name == "spudgun_spinner_shoot_tp" or name == "spudgun_spinner_shoot_tp" ) then
					setTpAnimation( self.tpAnimations, self.aiming and "spudgun_spinner_shoot_tp" or "spudgun_spinner_shoot_tp", 10.0 )
				elseif name == "spudgun_spinner_shoot_tp" then
	...
	for name, animation in pairs( self.tpAnimations.animations ) do
		...
		if name == "spudgun_spinner_shoot_tp" then
	...
	if ( ( ( isAnyOf( self.tpAnimations.currentAnimation, { "spudgun_spinner_shoot_tp", "spudgun_spinner_shoot_tp", "spudgun_spinner_shoot_tp" } ) and ( relativeMoveDirection:length() > 0 or isCrouching) ) or ( self.aiming and ( relativeMoveDirection:length() > 0 or isCrouching) ) ) and not isSprinting ) then
...
function PotatoGatling.client_onEquip( self, animate )
	...
	setTpAnimation( self.tpAnimations, "spudgun_spinner_shoot_tp", 0.0001 )
...
function PotatoGatling.cl_fire( self )
	...
	if not sm.game.getEnableAmmoConsumption() or sm.container.canSpend( sm.localPlayer.getInventory(), obj_plantables_potato, 1 ) then
		...
		if owner then
			sm.projectile.projectileAttack( projectile_bee, Damage, firePos, dir * fireMode.fireVelocity, owner, fakePosition, fakePositionSelf )
		end
